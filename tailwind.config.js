...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'casino': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)',
        'casino-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
        'casino-xl': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
      ...
      transitionTimingFunction: {
        'casino': 'cubic-bezier(0.4, 0, 0.2, 1)',
      },
    },
  },
  plugins: [
